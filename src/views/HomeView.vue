<template>
  <section class="mx-auto max-w-screen-xl h-5/6 px-4 flex items-center">
    <div class="mx-auto max-w-screen-xl text-center">
      <p class="mx-auto mt-4 max-w-2xl sm:text-xl/relaxed">
        Un test de escritura con teclado para medir la velocidad y precisión de escritura con una tematica Andaluza
        tradicional.
      </p>
